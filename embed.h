...
#define sv_2pv_flags(a,b,c)	S_sv_2pv_flags(aTHX_ a,b,c)
#define sv_2pv_flags_s(a,b)	Perl_sv_2pv_flags_s(aTHX_ a,b)
...
#define newSVpvsn(a,b)		Perl_newSVpvsn(aTHX_ a,b)
#define newSVpvsn_flags(a,b,c)	Perl_newSVpvsn_flags(aTHX_ a,b,c)
