...
..\lib\buildcustomize.pl : $(MINI_OBJ) $(LIBNTDLL) ..\write_buildcustomize.pl
.IF "$(CCTYPE)" == "GCC"
...
$(PERLDLL): $(LIBNTDLL) $(PERLEXPLIB) $(PERLDLL_OBJ) $(PERLDLL_RES) Extensions_static
.IF "$(CCTYPE)" == "GCC"
...
utils: $(PERLEXE) $(PERLDLL) ..\utils\Makefile
	cd ..\utils && dmake PERL=$(MINIPERL)
